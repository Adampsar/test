...
var createIFramePlayer = function(obj) {
    ...
    var defaults = {
        ...
        aspect: '16x9',
        player_id: 'cmiamvideoembed_' + Math.random().toString().slice(2),
        player_width: '100%',
        player_width: '100%',
        maxWidth: false,
        fullDomain: false,
    ...
    if (!document.getElementById('cmiamvideoembed')) {
        var head = document.getElementsByTagName('head')[0];
        var css = ' .cmiamvideoembed-embed { width: 100%; position: relative; height: auto; padding-bottom: 56.25%;} .cmiamvideoembed-embed iframe {position: absolute; top:0; left:0; width: 100%; height: 100%}';
        var style = document.createElement('style');
        style.setAttribute("id", "cmiamvideoembed");
        style.innerHTML =  css;
    ...
    var player = '<div class="cmiamvideoembed-wrap"><div class="cmiamvideoembed-embed" id="' + defaults.player_id + '" ' + aspectRatio + '>' + iframeCode + '</div></div>'
